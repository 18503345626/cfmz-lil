    ...
    <script type="application/javascript">
        $(function () {
            $("#captchaImage").click(function () {
                $("#captchaImage").prop("src","${path}/code/code?time"+new Date().getTime());
            });
            $.extend($.validator.messages,{
                required: "<span style='color: red'>这是必填字段</span>",
                minlength: $.validator.format("最少需要6个字符")
            });
                ...
                if(flag){
                    $.ajax({
                        ...
                        success:function (dat){
                            if(dat.suc!=200){
                                $("#msgDiv").html("<font style='color: red'>"+dat.message+" </font>")
                            }else{
                ...
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    <div class="form-top" style="width: 450px">
                        <div class="form-top-left">
                            ...
                            <p>Enter your username and password to log on: <font style="color: red">
                                ${requestScope.message}</font></p>
                        </div>
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="adminname" placeholder="请输入用户名..." class="form-username form-control" required id="form-username">
                            </div>
                            <div class="form-group">
                                <label class="sr-only" for="form-password">Password</label>
                                <input type="password" minlength="5" name="password" placeholder="请输入密码..." class="form-password form-control" required id="form-password">
                            </div>
                            <div class="form-group">
